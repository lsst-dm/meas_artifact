    ...
    for result in results:
        ...
        for candidate in candidateLookup[dataHash]:
            ...
            for iTrail,fTrail in enumerate(foundTrails):
                ...
                if t and  (candidate.kind in Candidate.positiveKinds) and (fTrail.isNear(t, rMax, thetaMax)):
            ...
            if not resultMsg:
                ...
                if t is None  or (candidate.kind in (Candidate.negativeKinds | Candidate.ignoredKinds)):
            ...
            if candidate.kind not in Candidate.ignoredKinds:
